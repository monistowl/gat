...
The helper writes a stub string ("stub visualization") to `--output` (if given) and prints a summary. This command is a reference implementation to ensure the CLI, shared plotting primitives, and installer scripts stay aligned until a full GUI ships.
