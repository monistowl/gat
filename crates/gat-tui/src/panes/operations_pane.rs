...
use crate::ui::{
    ...
    ProgressBarView, ProgressStatus, Sidebar, SubTabs, Tabs, Tooltip,
};
...
/// Operations pane for the TUI registry
...
impl OperationsPane {
    pub fn layout() -> PaneLayout {
        ...
        let batch_ops = Pane::new("Batch Operations")
            ...
            .with_tabs(Tabs::new(["Power Flow", "Optimal Flow"], 0));
        ...
        let alloc_ops = Pane::new("Allocation Analysis")
            ...
            .with_tabs(Tabs::new(["Rents", "Contribution"], 0));
