...
use crate::data::{create_fixture_datasets, DatasetStatus as FixtureDatasetStatus};
use crate::ui::{
    ContextButton, EmptyState, GridBrowserState, GridInfo, GridLoadState, Pane, PaneContext,
    PaneLayout, PaneView, ResponsiveRules, Sidebar, TableView, Tooltip,
};
...
/// Datasets pane for the TUI registry
    ...
    pub fn layout() -> PaneLayout {
        ...
        for dataset in &datasets {
            let status_icon = match dataset.status {
                FixtureDatasetStatus::Ready => "✓",
                FixtureDatasetStatus::Idle => "◆",
                FixtureDatasetStatus::Pending => "⟳",
            };
            let validation = match dataset.status {
                FixtureDatasetStatus::Ready => "✓ Validated",
                FixtureDatasetStatus::Idle => "△ Drift check",
                FixtureDatasetStatus::Pending => "… Pending",
            };
