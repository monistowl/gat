//! WASM-compatible string-based parsers
//!
//! This module exposes format parsers that work with string input, making them
//! suitable for WASM builds where filesystem access is unavailable.
//!
//! The parsers in this module are identical to those used in the `importers` module,
//! but without filesystem dependencies.

use anyhow::{anyhow, Context, Result};

use crate::helpers::{safe_f64_to_i32, safe_f64_to_usize};

// Re-export types that are used by the parser
...
///
/// This is the primary WASM-compatible entry point for parsing MATPOWER files.
/// The content string should contain the full MATPOWER .m file content.
///
/// # Example
/// ```
/// use gat_io::wasm_parsers::parse_matpower_string;
///
/// let content = r#"
/// mpc.version = '2';
/// mpc.baseMVA = 100.0;
